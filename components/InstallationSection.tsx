...
const InstallationSection: React.FC = () => {
  ...
  const commands = {
    npm: 'npx shadcn add @shadcnloaders/loader',
    yarn: 'npx shadcn add @shadcnloaders/loader',
    pnpm: 'npx shadcn add @shadcnloaders/loader',
    bun: 'npx shadcn add @shadcnloaders/loader'
  };
