    ...
    case "radar-sweep":
      return (
        ...
        >
          ...
          `}</style>
          <div className="absolute rounded-full border border-zinc-900/20 dark:border-zinc-50/20" style={{ inset: "22%" }} />
          <div className="absolute rounded-full border border-zinc-900/15 dark:border-zinc-50/15" style={{ inset: "42%" }} />
        ...
        >
          ...
          {[0, 60, 120, 180, 240, 300].map((a, i) => (
            <circle
              ...
              style={{ animation: `loader-flower-petal 1.2s ease-in-out ${i * 0.15}s infinite` }}
            />
          ))}
