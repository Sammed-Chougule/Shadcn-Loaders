...
const App: React.FC = () => {
    ...
    <header className="relative pt-32 pb-16 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-100 border border-zinc-200 mb-8 animate-fade-in">
          ...
          <span className="text-xs font-medium text-zinc-600">Free Open Source Component Library</span>
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-zinc-950 to-zinc-600 leading-tight">
          ...
          <span className="text-indigo-600">your next project.</span>
        </h1>
        
        <p className="text-xl text-zinc-600 mb-10 max-w-2xl mx-auto leading-relaxed">
          Inspired by shadcn/ui. Zero dependencies, fully customizable with Tailwind CSS, and easy CLI installation to get you running in seconds.
        </p>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Installation Section - Prominent First Section */}
      <section id="install" className="bg-zinc-50 py-20 border-y border-zinc-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
             <h2 className="text-3xl font-bold tracking-tight text-zinc-900 mb-4">Get Started Fast</h2>
             <p className="text-zinc-500 max-w-lg mx-auto">Copy and paste the command below to add our loader component directly into your project directory.</p>
          </div>
          <InstallationSection />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-zinc-500 text-sm max-w-xs">
              A premium collection of React loader components. Built with React and Tailwind CSS.
            </p>
          </div>
          ...
          <div className="flex gap-12">
            <div className="flex flex-col gap-3">
              ...
              <button onClick={() => scrollToSection('install')} className="text-zinc-500 hover:text-indigo-600 text-sm transition-colors text-left">Installation</button>
              <button onClick={() => scrollToSection('explore')} className="text-zinc-500 hover:text-indigo-600 text-sm transition-colors text-left">Components</button>
            </div>
            <div className="flex flex-col gap-3">
              <span className="text-zinc-900 font-semibold text-sm">Links</span>
              <a href="https://github.com/shadcn/ui" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-indigo-600 text-sm transition-colors">GitHub</a>
              <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-indigo-600 text-sm transition-colors">Discord</a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-indigo-600 text-sm transition-colors">Twitter</a>
            </div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-zinc-100 text-center">
          <p className="text-zinc-400 text-xs">
            © {new Date().getFullYear()} Shadcn Loaders. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
